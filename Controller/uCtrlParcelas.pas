...
function ctrlParcelas.DeleteListaParcelasCondPgto(const ACodCondPgto: Integer): Boolean;
begin
  aDaoParcelas.DeleteListaParcelasCondPgto(ACodCondPgto);
end;
...
function ctrlParcelas.RetornaListaParcelas(const ACodCondPgto: Integer): TObjectList<Parcela>;
begin
  Result := aDaoParcelas.RetornaListaParcelas(ACodCondPgto);
end;

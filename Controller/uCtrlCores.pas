...
procedure ctrlCores.setPosicao(acodigo: integer);
begin
  aDaoCores.setPosicao(aCodigo);
end;

function ctrlCores.ValidaExclusao(pObj: TObject): Boolean;
begin
  result := aDaoCores.ValidaExclusao(pObj);
end;

function ctrlCores.VerificaExiste(aChave: string): Boolean;
begin
  Result := aDaoCores.VerificaExiste(aChave);
end;

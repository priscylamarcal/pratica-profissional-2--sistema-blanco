...
procedure ctrlMarcas.setPosicao(acodigo: integer);
begin
  aDaoMarca.setPosicao(aCodigo);
end;

function ctrlMarcas.ValidaExclusao(pObj: TObject): Boolean;
begin
  result := aDaoMarca.ValidaExclusao(pObj);
end;

function ctrlMarcas.VerificaExiste(aChave: string): Boolean;
begin
  Result := aDaoMarca.VerificaExiste(aChave);
end;

...
function ctrlEstados.ValidaExclusao(pObj: TObject): Boolean;
begin
  Result := aDaoEstados.ValidaExclusao(pObj);
end;

function ctrlEstados.VerificaExiste(oEstado: Estados): Boolean;
begin
  Result := aDaoEstados.VerificaExiste(oEstado);
end;

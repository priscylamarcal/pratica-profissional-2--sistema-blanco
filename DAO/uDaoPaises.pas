...
begin
  ...
  try
    ...
    begin
       aDM.QPaises.Insert;
       aDM.QPaises.FieldByName('DATACAD').AsDateTime:= now;
    end
    else
      aDM.QPaises.Edit;
    ...
    aDM.QPaises.FieldByName('ULTALT').AsDateTime:= now;
    aDM.QPaises.FieldByName('CODUSUALT').AsInteger:= mPais.getCodUsu;
...
procedure daoPaises.setPosicao(aCodigo: integer);
begin
  aDM.QPaises.Locate('CODPAIS', aCodigo, []);
end;

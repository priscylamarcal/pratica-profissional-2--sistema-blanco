...
begin
  ...
  mFormaPagamento.setUltAlt( aDM.QFormasPagamentos.FieldByName('ULTALT').AsDateTime );
end;
...
begin
  ...
  try
    ...
    begin
       ...
       aDM.QFormasPagamentos.FieldByName('DATACAD').AsDateTime:= now;
    end
    else
    ...
    aDM.QFormasPagamentos.FieldByName('ULTALT').AsDateTime:= now;
...
procedure daoFormasPagamentos.setPosicao(acodigo: integer);
begin
  aDM.QFormasPagamentos.Locate('CODFORMA', aCodigo, []);
end;

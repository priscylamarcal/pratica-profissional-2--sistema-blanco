...
type
  TDM = class(TDataModule)
    ...
    QComprasSERIE: TStringField;
    QComprasNUMERO: TStringField;
    QComprasCOD_FORNECEDOR: TIntegerField;
    QComprasCOD_CONDICAO: TIntegerField;
    QComprasDATA_EMISSAO: TSQLTimeStampField;
    QComprasDATA_CHEGADA: TSQLTimeStampField;
    QComprasQTD: TIntegerField;
    QComprasDESCONTO: TSingleField;
    QComprasVALOR_TOTAL: TSingleField;
    QComprasFRETE: TSingleField;
    QComprasSEGURO: TSingleField;
    QComprasOUTRAS_DESPESAS: TSingleField;
    QComprasDATACAD: TSQLTimeStampField;
    QComprasULTALT: TSQLTimeStampField;
    QComprasCODUSU: TIntegerField;
    QComprasOBS: TStringField;
    QProdutosCompras: TFDQuery;
    DsProdutosCompras: TDataSource;
    QProdutosComprasCOD_ROUPA: TIntegerField;
    QProdutosComprasNUMERO_VARIACAO: TIntegerField;
    QProdutosComprasQTD: TIntegerField;
    QProdutosComprasVALOR_UNITARIO: TSingleField;
    QProdutosComprasDESCONTO: TSingleField;
    QProdutosComprasVALOR_TOTAL: TSingleField;
    QProdutosComprasMODELO: TStringField;
    QProdutosComprasSERIE: TStringField;
    QProdutosComprasNUMERO: TStringField;
    QProdutosComprasCOD_FORNECEDOR: TIntegerField;
    QVariacoesProdutos: TFDQuery;
    DSVariacoesProdutos: TDataSource;
    QVariacoesProdutosCOD_ROUPA: TIntegerField;
    QVariacoesProdutosDESCRICAO_ROUPA: TStringField;
    QVariacoesProdutosCOR: TStringField;
    QVariacoesProdutosSIGLA: TStringField;
    QVariacoesProdutosUNIDADE_MEDIDA: TStringField;
    QVariacoesProdutosCODIGO: TStringField;
    QVariacoesProdutosNUMERO_VARIACAO: TIntegerField;
    QVariacoesProdutosCODCOR: TIntegerField;
    QVariacoesProdutosCODSIGLA: TIntegerField;
    QProdutosComprasNUMERO_PRODUTO: TIntegerField;
    QParcelasCompras: TFDQuery;
    DSParcelasCompras: TDataSource;
    QParcelasComprasNUMERO_PARCELA: TIntegerField;
    QParcelasComprasDATA_VENCIMENTO: TSQLTimeStampField;
    QParcelasComprasVALOR: TSingleField;
    QParcelasComprasCODCONDICAO: TIntegerField;
    QParcelasComprasMODELO: TStringField;
    QParcelasComprasSERIE: TStringField;
    QParcelasComprasNUMERO: TStringField;
    QParcelasComprasCOD_FORNECEDOR: TIntegerField;
    QComprasNOMEFORNECEDOR: TStringField;
  private

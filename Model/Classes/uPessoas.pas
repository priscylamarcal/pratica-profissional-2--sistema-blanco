unit uPessoas;
interface
uses uCidades, uTiposContatos, uContatos, System.Generics.Collections;
type
  Pessoas = class
  private
...
//    contato_aux2        : string[50];
    ListaContatos       : TObjectList<Contato>;
    cnpj_cpf            : string[25];
    ie_rg               : string[14];
  public
    constructor crieObj;
...
//    procedure setContatoAux2 ( pContatoAux2 : string );
    ...
    procedure setListaContatos( pListaContatos: TObjectList<Contato>);
...
//    function getContatoAux2  : string;
    ...
    function getListaContatos: TObjectList<Contato>;
...
begin
  ...
  ListaContatos       := TObjectList<Contato>.create;
  self.LimparDados;
end;
...
function Pessoas.getListaContatos: TObjectList<Contato>;
begin
...
procedure Pessoas.setListaContatos(pListaContatos: TObjectList<Contato>);
begin
  ListaContatos := pListaContatos;
end;

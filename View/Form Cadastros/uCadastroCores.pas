...
//    aCor.setDataCad(Date);
    ...
    begin
      ...
      begin
        ...
        // verifica se existe Cor quando é incluir
        begin
          ShowMessage('Já existe uma Cor ' + aCor.getCor + ' cadastrada!');
          edt_cor.SetFocus;
          Exit;
        end;
      end
      ...
      begin
        if not(NomeCor = aCor.getCor) then
          if (aCtrlCor.VerificaExiste(aCor.getCor)) then
          // se mudou verifica se já existe Cor com o nome
          begin
            aCtrlCor.SetPosicao(aCor.getCodigo);
            ShowMessage('Já existe uma Cor ' + aCor.getCor +
              ' cadastrada!');
            edt_cor.SetFocus;
            Exit;
          end;
      ...
      ShowMessage
        ('A Cor está vinculada a uma ou mais roupas, não pode ser excluída!');

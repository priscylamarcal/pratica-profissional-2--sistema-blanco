...
//    oEstado.setUltAlt(Date);
    ...
    begin
      ...
      begin
        ...
        begin
          ShowMessage('Já existe um Estado ' + oEstado.getEstado +
            ' cadastrado no país ' + oEstado.getoPais.getPais + '!');
          edt_estado.SetFocus;
          Exit;
        end;
      end
      ...
      if aCtrlEstados.ValidaExclusao(oEstado.clone) then
        ...
        ShowMessage
          ('O Estado está cadastrado em uma cidade, não pode ser excluído!');
    self.sair;
  end;
end;

  ...
  begin
    ...
    begin
      ...
      begin
        ...
        // verifica se existe Tipo de Contato quando é incluir
        begin
          ShowMessage('Já existe um Tipo de Contato ' +
      ...
      begin
        if not(NomeTipoContato = oTipoContato.getTipoContato) then
          ...
          then // se mudou verifica se já existe Tipo de Contato com o nome
          begin
      ...
      if aCtrlTiposContatos.ValidaExclusao(oTipoContato.clone) then
        ...
        ShowMessage
          ('O Tipo de Contato está sendo usado por outro registro, não pode ser excluído!');

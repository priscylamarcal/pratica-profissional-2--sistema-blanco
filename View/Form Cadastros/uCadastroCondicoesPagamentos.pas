...
begin
  ...
  begin
    MessageDlg('A condição de pagamento deve possuir pelo menos uma parcela!',
...
procedure Tform_cadastro_condicao_pagamento.adicionarItens(pEdit: Boolean);
  ...
  begin
    ...
    begin
      MessageDlg('O campo Número de Parcelas é obrigatório!', MtInformation,
        [MbOK], 0);
    ...
    begin
      MessageDlg('O campo Porcentagem é obrigatório!', MtInformation,
        [MbOK], 0);
    ...
    begin
      MessageDlg('A porcentagem não pode ultrapassar 100%!', MtInformation,
        [MbOK], 0);
      edt_porcentagem.SetFocus;
      Exit;
    end;
    ...
    begin
      MessageDlg('O total da porcentagem não pode ultrapassar de 100%!',
        MtInformation, [MbOK], 0);
      edt_porcentagem.SetFocus;
      Exit;
    end;
    ...
    begin
      MessageDlg('A forma de pagamento é obrigatória!', MtInformation,
        [MbOK], 0);
    ...
    begin
      MessageDlg
        ('O dia informado não pode ser menor ou igual ao último dia da parcela adicionada!',
        MtInformation, [MbOK], 0);
      edt_dias.SetFocus;
      Exit;
    end;
    ...
    begin
      MessageDlg('Informe uma Forma de Pagamento Válida!', MtInformation,
        [MbOK], 0);
...
begin
  ...
  begin
    ...
    MessageDlg('Primeiro deve excluir a última parcela!', MtInformation,
      [MbOK], 0);
end;

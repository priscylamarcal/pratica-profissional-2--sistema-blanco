...
//    oGrupoRoupa.setDataCad(Date);
    ...
    begin
      ...
      begin
        ...
        // verifica se existe Grupo quando é incluir
        begin
          ShowMessage('Já existe um Grupo de Roupas ' +
      ...
      begin
        if not(NomeGrupoProduto = oGrupoRoupa.getGrupoRoupa) then
          if (aCtrlGruposRoupas.VerificaExiste(oGrupoRoupa.getGrupoRoupa)) then
          // se mudou verifica se já existe Grupo com o nome
          begin
      ...
      ShowMessage
        ('O Grupo de Roupas está vinculado a uma ou mais roupas, não pode ser excluído!');
...
begin
  ...
  begin
    MessageDlg('O campo Grupo de Roupa é obrigatório!', MtInformation,
      [MbOK], 0);
    edt_grupo_produto.SetFocus;
    Exit;
  end;

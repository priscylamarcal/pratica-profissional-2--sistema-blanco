...
//    aMarca.setUltAlt(Date);
    ...
    begin
      ...
      begin
        ...
        // verifica se existe Marca quando é incluir
        begin
          ShowMessage('Já existe uma Marca ' + aMarca.getMarca +
            ' cadastrada!');
          edt_marca.SetFocus;
          Exit;
        end;
      ...
      begin
        if not(NomeMarca = aMarca.getMarca) then
          if (aCtrlMarca.VerificaExiste(aMarca.getMarca)) then
          // se mudou verifica se já existe Marca com o nome
          begin
      ...
      ShowMessage
        ('A Marca está vinculada a uma ou mais Roupas, não pode ser excluída!');

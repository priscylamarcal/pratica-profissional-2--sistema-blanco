...
procedure Tform_consulta_paises.btn_botao_novoClick(Sender: TObject);
begin
  // Self.Novo;
  inherited;
end;
...
begin
  ...
  oCadastroPaises.ShowModal;
  if oCadastroPaises.salvou then
    Self.pesquisar;
end;
      ...
      case combobox_tipo_filtro.ItemIndex of
        ...
        1:
          begin
            ...
            begin
              MessageDlg('Digite ao menos 3 caracteres para consulta!',
